    ...
    <div class="row">
        <div class="col-md-8 col-12">
            <div class="card">
                ...
                <h4 class="card-title"><?=$speakers_edit_header?>: <b><?=$name?></b>  </h4>
                </div>
                <div class="card-content">
                <div class="card-body">
                    <form class="form form-horizontal" action="core/mngSpeakers.php" method="POST"  enctype="multipart/form-data" data-parsley-validate>
                    <div class="form-body">
                        <div class="row">
                        <div class="col-md-3">
                            ...
                            <div class="form-group has-icon-left">
                                <div class="form-check mandatory">
                                    <div class="position-relative">
                                        ...
                                        type="text"
                                        class="form-control"
                                        placeholder="<?=$speakers_add_name_ph?>"
                                        id="name"
                                        name="name"
                        ...
                        <div class="col-md-3">
                            <label><?=$speakers_add_desc?> <span class="text-danger">*</span></label>
                        </div>
                        <div class="col-md-9 my-3">
                            <div class="form-group has-icon-left">
                                <div class="form-check mandatory">
                        ...
                        <input type="hidden" name="origin" value="editSpeaker">
