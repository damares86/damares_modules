...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3 class="d-inline">Modifica un paziente</h3>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Cognome del paziente" name="cognome" data-parsley-required="true" value="<?= $row1['cognome'] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="Nome del paziente" name="nome" data-parsley-required="true" value="<?= $row1['nome'] ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="form-check mandatory">
                                                                <div class="position-relative">
                                                                    <fieldset class="form-group">
                                                                        <select class="form-select" name="farmaco_<?= $i ?>">
                                                                            <?php
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            <div class="form-check mandatory">
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control" placeholder="0" name="cpr_<?= $i ?>" data-parsley-required="true" value="<?= $row2['cpr'] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-1">
                                                        <div class="form-group">
                                                            <div class="form-check mandatory">
                                                                <div class="position-relative">
                                                                    <input type="text" class="form-control" placeholder="0" name="magazzino_<?= $i ?>" data-parsley-required="true" value="<?= $row2['magazzino'] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <fieldset class="form-group">
                                                        <select class="form-select" name="farmaco">
                                                            <?php
                                                            $rsa->table = "farmaci";
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="0" name="cpr" data-parsley-required="true" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="0" name="magazzino" data-parsley-required="true" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
