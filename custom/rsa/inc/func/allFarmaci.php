...
<section class="section">
  <div class="card">
    <div class="card-header">Tutti i farmaci &nbsp; &nbsp; &nbsp;
      <a href="index.php?p=addFarmaco" class="btn icon icon-left btn-success"><i data-feather="plus-circle"></i> Aggiungi un farmaco</a>
    </div>
    <div class="card-body">
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?= $row['cpr_box'] ?></td>
              <td>
                <a href="index.php?p=editFarmaco&idToMod=<?= $row['id'] ?>" class="btn icon btn-warning shadow edit-link" data-base-url="index.php?p=editFarmaco&idToMod=<?= $row['id'] ?>"><i class="bi bi-pencil-square"></i> Modifica</a>
                &nbsp; &nbsp;
                  ...
                  <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <span class="d-none d-sm-block"><a href="core/mngFarmaci.php?idToDel=<?= $row['id'] ?>" class="btn btn-danger ml-1">
