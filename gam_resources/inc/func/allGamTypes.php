...
<section class="section">
  <div class="card shadow">
    <div class="card-header"><?=$gam_all_type_title?> &nbsp; &nbsp; &nbsp; 
                    <a href="index.php?p=addGamType" class="btn icon icon-left btn-success shadow"
      ...
      <table class="table" id="table1">
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="index.php?p=editGamType&idToMod=<?=$row['id']?>" class="btn icon btn-warning shadow"
