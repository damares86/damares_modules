            ...
            <div class="col-md-8 col-12">
                <div class="card shadow">
                    <div class="card-header">
                        <h4 class="card-title"><?=$addarchive_title?></h4>
                    </div>
                        ...
                        <div class="card-body">
                            <form class="form form-horizontal upload-form" action="core/mngArchive.php" method="POST" enctype="multipart/form-data" data-parsley-validate>
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label><?=$addarchive_title_file?> <span class="text-danger">*</span></label>
                                        </div>
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <div class="form-check mandatory">
                                                    <div class="position-relative">
                                                        <input type="text" class="form-control" placeholder="<?=$addarchive_title_file?> " id="first-name-icon" name="title" data-parsley-required="true" />
                                        ...
                                        <div class="col-md-3">
                                        <label><?=$addarchive_year?> <span class="text-danger">*</span></label>
                                    </div>
                                    <div class="col-md-9">
                                        <div class="form-group">
                                            <div class="form-check mandatory">
