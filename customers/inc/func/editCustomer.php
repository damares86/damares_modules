...
<div class="page-title">
    <div class="row">
        <div class="col-12 col-md-6 order-md-1 order-last">
            <h3 class="d-inline"><?= $customer_edit_header ?></h3>
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group has-icon-left">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="<?= $customer_add_name_ph ?>" id="first-name" name="name" data-parsley-required="true" value="<?= $name ?>" />
                                    ...
                                    <div class="col-md-9">
                                        <div class="form-group has-icon-left">
                                            <div class="form-check mandatory">
                                                <div class="position-relative">
                                                    <input type="text" class="form-control" placeholder="<?= $customer_add_surname_ph ?>" id="surname" name="surname" data-parsley-required="true" value="<?= $surname ?>" />
                                                    <div class="form-control-icon">
                                                        <i class="bi bi-person"></i>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-9">
                                            <div class="form-group">
                                                <div class="position-relative">
                                                    ...
                                                    ?>
                                                    <input type="<?= $type ?>" class="form-control" placeholder="<?= $item_label ?>" name="<?= $item ?>" value="<?= $value ?>" />
